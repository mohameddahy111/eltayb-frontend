            ...
            <Card sx={{ position: "relative" }}>
              {mainIamag ? (
                <>
                  <CardMedia
                    component={"img"}
                    src={mainIamag ? URL.createObjectURL(mainIamag[0]) : ""}
                  />
                ...
                >
                  ...
                  <Typography  textTransform={"uppercase"}  fontWeight={700} align="center" mb={1}>or</Typography>
                  <Box>
                    <TextField
                    ...
                    .map((x, index) => (
                      ...
                      >
                        {x === "offer" ? (
                          ...
                          <TextField
                            value={
                              x === "offerPrice" && formik.values.offer === true
                                ? parseFloat(
                                    formik.values.price -
                                      (formik.values.price *
                                        formik.values.offerValue) /
                                        100
                                  ).toFixed(2)
                                : x === "offerValue" &&
                                  formik.values.offer === false
                                ? ""
                                : formik.values[x]
                            }
                            name={x}
